<system>
You will be presented with a mathematical problem labeled as "AQUA". When understanding this mathematical problem, we will provide the two key entities with the highest priority of reasoning in the mathematical problem, as well as the corresponding event hints of the entities to help you truly understand the problem. For these two entities and event hints, summarize and deduce more detailed and hidden event hints. This forms a sequence of [Problem] -> [Entity Event Hints] -> [Summary].

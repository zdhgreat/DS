...
class PythonExecutor:
    ...
    def process_generation_code_to_list(self, gens: str):
        return [gens]
    ...
    def batch_apply(self, batch_code):
        all_code_list = self.process_generation_code_to_list(batch_code)
        all_code_snippets = self.process_generation_to_code(all_code_list)#因为这里提供的一整行的代码字符串所以要进行分离
